...
export default function ModuleManagerComponent(props){
    ...
    const saveModule = async()=>{
        ...
        if(!params.moduleName)
            setModules([...modules,{...moduleMap,"id":moduleMap.apiName}])
        navigate("../module/"+moduleName.pluralName+(!params.moduleName?"?id=new":""));
        setLoading(false)
    };
    ...
    return (<><div className={isLoading?"loader":""}></div><div className={"moduleManagerContainer"}>
                {!moduleName? <div className="noRecords">Module Not Found</div>:<>
                ...
                <div className="moduleForm" key={moduleName?moduleName.apiName:"new"}>
                    <div className="moduleFormInner">
                        <div className="fieldsHolder moduleName">
                            ...
                            <div className="fNameInput"><input type="text" name="pluralName" placeholder="Plural Name" value={moduleName.pluralName} onChange={handleModuleNameInput}></input>{error.pluralName && <div className="fieldError">{error.pluralName}</div>}</div>
                            <div className="fNameInput"><input type="text" name="singularName" placeholder="Singluar Name" value={moduleName.singularName} onChange={handleModuleNameInput}></input>{error.singularName && <div className="fieldError">{error.singularName}</div>}</div>
                        ...
                        <div class="fieldsAddContainer">
                            ...
                            <div className="fieldSettingsPopup">
                                <div className="fieldSettingsHeader">Field Settings</div>
